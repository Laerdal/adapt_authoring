...
OutputPlugin.prototype.writeThemeVariables = function(courseId, theme, themeVariables, destinationFolder, next) {
  ...
  async.series([
    function(seriesCallback) {
      ...
      // PERFORMANCE: Use async.each for CPU-bound object processing
      async.each(Object.keys(variables), function(key, innerCallback) {
        ...
        async.each(Object.keys(nestedProps), function(childKey, secondInnerCallback) {
    ...
    function(seriesCallback) {
      ...
      // PERFORMANCE: Use async.each for CPU-bound object flattening
      async.each(Object.keys(themeVariables), function(key, innerCallback) {
