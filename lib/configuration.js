...
Configuration.prototype.load = function (filePath, callback) {
  ...
  if (process.env.OPENAI_ENDPOINT) {
    config.conf.openaiEndpoint = process.env.OPENAI_ENDPOINT;
  }
  if (process.env.OPENAI_API_VERSION) {
    config.conf.openaiApiVersion = process.env.OPENAI_API_VERSION;
  }
  if (process.env.OPENAI_API_KEY) {
    config.conf.openaiApiKey = process.env.OPENAI_API_KEY;
  }
  if (process.env.OPENAI_MODEL) {
    config.conf.openaiModel = process.env.OPENAI_MODEL;
  }
