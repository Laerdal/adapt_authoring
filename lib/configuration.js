...
Configuration.prototype.load = function (filePath, callback) {
  ...
  if (process.env.CKEditor_AI_ASST_ENDPOINT) {
    config.conf.ckEditorAIEndPoint = process.env.CKEditor_AI_ASST_ENDPOINT;
  }
  if (process.env.CKEditor_AI_ASST_API_Version) {
    config.conf.ckEditorAIAPIVersion = process.env.CKEditor_AI_ASST_API_Version;
  }
  if (process.env.CKEditor_AI_ASST_API_model) {
    config.conf.ckEditorAIAPIModel = process.env.CKEditor_AI_ASST_API_model;
  }
